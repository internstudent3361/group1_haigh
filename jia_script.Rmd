...
confusion.plot <- figure.2.fun(y_var = exptwofinaldata$confusion, plot_title = "Nutitional Confusion", y_title = "Nutitional Confusion")
backlash.plot <- figure.2.fun(y_var = exptwofinaldata$backlash, plot_title = "Nutitional Backlash", y_title = "Nutitional Backlash")
